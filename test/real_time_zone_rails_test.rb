...
# Test if the original ActiveSupport::TimeZone behaviour is not changed.
# Test codes are copied from original ActiveSupport::TimeZoneTest
# https://github.com/rails/rails/blob/v5.1.4/activesupport/test/time_zone_test.rb

class RealTimeZoneRailsTest < ActiveSupport::TestCase
  ...
  # This method is overridden by virtual_time_zone_rails
